...
from lesspass import get_set_of_characters
from lesspass import get_one_char_per_rule
from lesspass import get_configured_rules
...
class SetOfCharactersTests(unittest.TestCase):
    ...
    def test_get_default_characters(self):
        ...
        set_of_characters = get_set_of_characters()
        self.assertEqual(
    ...
    def test_concat_rules_in_order(self):
        ...
        set_of_characters = get_set_of_characters(['lowercase', 'uppercase', 'numbers'])
        self.assertEqual(
            'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789',
            set_of_characters
        )
    ...
    def test_only_lowercase(self):
        ...
        set_of_characters = get_set_of_characters(['lowercase'])
    ...
    def test_configured_rules(self):
        ...
        self.assertEqual(['uppercase'], get_configured_rules({
            'uppercase': True}))
        self.assertEqual(['lowercase', 'uppercase'], get_configured_rules({
            'uppercase': True, 'lowercase': True}))
        self.assertEqual(['lowercase'], get_configured_rules({
            'lowercase': True, 'symbols': False}))
        self.assertEqual(['lowercase', 'uppercase', 'numbers', 'symbols'], get_configured_rules({
