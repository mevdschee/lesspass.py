...
class EntropyTests(unittest.TestCase):
    ...
    def test_with_different_options(self):
        ...
        entropy = calc_entropy(site, login, master_password, password_profile)
        self.assertEqual('fff211c16a4e776b3574c6a5c91fd252', entropy.decode('utf-8'))
    ...
    def test_with_counter_one(self):
        ...
        entropy = calc_entropy(site, login, master_password, password_profile)
        self.assertEqual('d3ec1e988dd0b3640c7491cd2c2a88b5', entropy.decode('utf-8'))
    ...
    def test_with_counter_two(self):
        ...
        entropy = calc_entropy(site, login, master_password, password_profile)
        self.assertEqual('ddfb1136260f930c21f6d72f6eddbd40', entropy.decode('utf-8'))

    def test_consume_entropy(self):
        """test_consume_entropy function"""
        value, entropy = consume_entropy('', int(4 * 4 + 2), 'abcd', 2)
